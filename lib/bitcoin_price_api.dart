...
Future<int> fetchBitcoinPrice() async {
  ...
  // final response = await http.get(Uri.parse('https://mempool.space/api/v1/prices'));
...
Future<List<BitcoinPriceData>> fetchHistoricalBitcoinPriceData() async {
  try {
    final response = await http.get(Uri.parse('https://mempool.space/api/v1/historical-price'));
